...
FILE=`find $TEMPDIR/repositories_dir/$folder -name "*.h" -o -name "*.c" -o -name "*.H" -o -name "*.C" -o -name "*.hpp" -o -name "*.cpp" -o -name "*.cxx" -o -name "*.hxx" -o -name "*.hh" -o -name "*.cc" -o -name "*.c++" -o -name "*.h++"`
