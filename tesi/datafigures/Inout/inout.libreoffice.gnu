...
GNUTERM = "wxt"
set key title "Project LibreOffice-core"
p [][0.0001:]"./data/N9172.16.LibreOffice-core.4cpp.outd" pt 2 lc 1 title "Outdegree", exp(-1.65)*x**(-2.1) lc 1 lw 2 title "x^{-2.1}", "./data/N9172.16.LibreOffice-core.4cpp.ind" title "Indegree" pt 2 lc 2, exp(-0.4)*x**(-2.7) lc 2 lw 2 title "x^{-2.7}"
#    EOF
