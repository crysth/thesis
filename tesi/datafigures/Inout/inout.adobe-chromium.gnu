...
GNUTERM = "wxt"
set key title "Project Adobe-Chromium"
p [][0.0001:]"./data/N5323.8.adobe-chromium.0cpp.outd" pt 2 lc 1 title "Outdegree", exp(-1.7)*x**(-2.0) lc 1 lw 2 title "x^{-2.0}", "./data/N5323.8.adobe-chromium.0cpp.ind" title "Indegree" pt 2 lc 2, exp(-0.43)*x**(-3.) lc 2 lw 2 title "x^{-3.0}"
#    EOF
