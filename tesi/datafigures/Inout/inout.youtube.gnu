...
unset grid
set raxis
set key title "Project Youtube-h5vcc"
...
f(x)=a*x**(-b) 
g(x)=d*x**(-e) 
#fit [1:20]f(x) "./outdegrees/N9701.10.youtube-h5vcc.0cpp.outd" via a,b
#fit [1:10]g(x) "./indegrees/N9701.10.youtube-h5vcc.0cpp.ind" via d,e
p [][0.0001:]"./data/N9701.10.youtube-h5vcc.0cpp.outd" pt 2 lc 1 title "Outdegree", exp(-2)*x**(-1.9) lc 1 lw 2 title "x^{-1.9}", "./data/N9701.10.youtube-h5vcc.0cpp.ind" title "Indegree" pt 2 lc 2, exp(0.15)*x**(-3.5) lc 2 lw 2 title "x^{-3.5}"
#    EOF
