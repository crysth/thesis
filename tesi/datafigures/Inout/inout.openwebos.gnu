...
GNUTERM = "wxt"
set key title "Project OpenWeb OS"
p [][0.0001:]"./data/N6215.9.openwebos-qt.4cpp.outd" pt 2 lc 1 title "Outdegree", exp(-2.3)*x**(-1.8) lc 1 lw 2 title "x^{-2.0}", "./data/N6215.9.openwebos-qt.4cpp.ind" title "Indegree" pt 2 lc 2, exp(-0.11)*x**(-4.3) lc 2 lw 2 title "x^{-3.0}"
#    EOF
