...
set ylabel "Depth of graphs" offset 1.5
#set ylabel offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270

set yrange [ 1.00000 : 15.0000 ] noreverse nowriteback
...
#p "./data/prova.dat" matrix with image
p "./data/HdepVSNnodes.cpp.dat" matrix with image, "data/LdepVSNnodes.log.cpp.dat" w lp ps 3 pt 7 lw 3
