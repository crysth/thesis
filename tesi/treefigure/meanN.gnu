...
set raxis
set key title ""
set key at 800, 20, 0 right top vertical Right noreverse enhanced autotitles nobox
...
set xlabel "Sets of extractions N" 
...
p "data/lamean.dat" lc 4 pt 5 ps 1.5 title "<{/Symbol w}> (N)"
set logscale x
set xtics auto
unset key
unset ylabel
