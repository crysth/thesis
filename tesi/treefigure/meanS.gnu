...
set raxis
set key title ""
set key at 4000, 200, 0 right top vertical Right noreverse enhanced autotitles nobox
...
set xlabel "Alphabet dimension S" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Mean presence of most common symbol" 
...
set xtics 1000
p "data/funxionediesse.dat" lc 4 pt 5 ps 1.5 title "<{/Symbol w}> (S)"
set logscale x
set xtics auto
unset key
unset ylabel
