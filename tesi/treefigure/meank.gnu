...
set raxis
set key title ""
set key at 450, 50, 0 right top vertical Right noreverse enhanced autotitles nobox
...
set xlabel "Size of sequences k" 
...
set xtics 100
p "data/funxionedikappa.dat" lc 4 pt 5 ps 1.5 title "<{/Symbol w}> (k)"
set logscale x
set xtics auto
unset key
unset ylabel
