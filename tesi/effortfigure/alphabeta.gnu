...
set raxis
set key title ""
set key at 3.5, 0.3, 0 right top vertical Right noreverse enhanced autotitles nobox
...
GNUTERM = "qt"
p [0:4][0:1.5]log(x)-log(1-exp(-x)) title "{/Symbol a} = log({/Symbol b}) - log(1-e^{-{/Symbol b}})" lw 3.5 lc 4
#    EOF
