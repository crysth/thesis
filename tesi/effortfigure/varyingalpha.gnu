...
a = 1.47360243327796
b = 1.00716515742409
GPFUN_f = "f(x)=a*log(x) + b"
FIT_CONVERGED = 1
FIT_NDF = 8
FIT_STDFIT = 0.304886658217499
FIT_WSSR = 0.743646994872274
c = 1.29599150138506
d = 1.06563036837694
GPFUN_g = "g(x)=c*log(x) + d"
e = 1.02515546521815
z = 1.5222018334601
GPFUN_h = "h(x)=e*log(x) + z"
p [1:1500][2:13] f(x) w l lw 3 lc 3 notitle, "data/odepVSlea.leaves.001.dat" w p ps 1.5 lc 3 lt 7 title "0.01", g(x) w l lw 3 lc 4 notitle, "data/odepVSlea.leaves.15.dat" w p ps 1.5 pt 7 lc 4 title "0.15", "data/odepVSlea.leaves.3.dat" w p ps 1.5 lc 2 pt 7 title "0.3",h(x) w l lw 3 lc 2 notitle
