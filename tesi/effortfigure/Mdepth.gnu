...
unset logscale
set format y
set ylabel "Outdegree mean" offset 1.1
set ylabel "Outdegree mean"
set xlabel "Levels"
set xtics 2
set ytics 1
i = 11
p [1:13][1:] for[i=8:11:1]"data/outdegVSlev.1000.1.depth.dat" u 1:i w l lc i-6 title sprintf("%d",i+1)
#p [1:13][1:] for[i=8:11:1]"data/outdegVSlev.1000.1.depth.dat" u 1:i w lp lc i-6 ps 1.5 pt (i-6)*2 title sprintf("%d",i+1)
unset multiplot
