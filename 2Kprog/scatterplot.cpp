...
void Scatterplot::levels_Nnodes(Packagegraph *pac, size_t minimum, bool level){
	if (_check==0) cerr<<"Scatterplot:: path non dichiarato!"<<endl;
		...
		if(_check1==0){
			_ff1.open(_path+"/scatterplot/1levelVSNnodes."+_language+".dat",ios::out);
			_ff2.open(_path+"/scatterplot/2levelVSNnodes."+_language+".dat",ios::out);
			_ff3.open(_path+"/scatterplot/3levelVSNnodes."+_language+".dat",ios::out);
			_ff4.open(_path+"/scatterplot/4levelVSNnodes."+_language+".dat",ios::out);
			_ff5.open(_path+"/scatterplot/5levelVSNnodes."+_language+".dat",ios::out);
			_ff6.open(_path+"/scatterplot/6levelVSNnodes."+_language+".dat",ios::out);
			_ff7.open(_path+"/scatterplot/7levelVSNnodes."+_language+".dat",ios::out);
			_ff1<<"#levels\tNnodes\n";
			_ff2<<"#levels\tNnodes\n";
			_ff3<<"#levels\tNnodes\n";
			_ff4<<"#levels\tNnodes\n";
